...
## Что Elephant Code может сделать для ВАС?
...
Elephant Code адаптируется к вашему стилю работы, а не наоборот:
...
- **[Документация](https://docs.zoocode.dev):** Официальное руководство по установке, настройке и освоению Elephant Code.
...
- **[Проблемы на GitHub](https://github.com/Elephant-Code-Org/Elephant-Code/issues):** Сообщайте об ошибках и отслеживайте разработку.
- **[Запросы на новые функции](https://github.com/Elephant-Code-Org/Elephant-Code/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Есть идея? Поделитесь ею с разработчиками.
...
Существует несколько способов запустить расширение Elephant Code:

### Режим разработки (F5)

Для активной разработки используйте встроенную отладку VSCode:

Нажмите `F5` (или перейдите в меню **Выполнить** → **Начать отладку**) в VSCode. Это откроет новое окно VSCode с запущенным расширением Elephant Code.
...
**Наслаждайся Elephant Code!** Будешь ли ты держать его на коротком поводке или позволишь ему действовать автономно, нам не терпится увидеть, что ты построишь. Если у тебя есть вопросы или идеи для новых функций, открой [issue](https://github.com/Elephant-Code-Org/Elephant-Code/issues) или начни [discussion](https://github.com/Elephant-Code-Org/Elephant-Code/discussions). Приятного кодинга!
