...
### 3. Присоединяйся к сообществу Elephant Code
...
- **Проверьте существующие задачи**: выполните поиск в [задачах GitHub](https://github.com/Elephant-Code-Org/Elephant-Code/issues).
...
- Проверь [страницу GitHub Issues](https://github.com/Elephant-Code-Org/Elephant-Code/issues), чтобы найти issues.
- Для документации посетите [Документацию Elephant Code](https://github.com/Elephant-Code-Org/Elephant-Code-Docs).

### Сообщение об ошибках

- Сначала проверьте существующие отчеты.
- Создайте новую ошибку, используя [шаблон «Отчет об ошибке»](https://github.com/Elephant-Code-Org/Elephant-Code/issues/new/choose) с:
    - Четкими, пронумерованными шагами воспроизведения
    - Ожидаемым и фактическим результатом
    - Версией Elephant Code (обязательно); поставщиком/моделью ИИ, если применимо
- **Проблемы с безопасностью**: сообщайте в частном порядке через [рекомендации по безопасности](https://github.com/Elephant-Code-Org/Elephant-Code/security/advisories/new).
...
Внося свой вклад, вы соглашаетесь с тем, что ваши вклады будут лицензироваться по лицензии Apache 2.0, в соответствии с лицензированием Elephant Code.
