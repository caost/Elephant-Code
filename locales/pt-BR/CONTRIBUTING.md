...
### 3. Junte-se à comunidade do Elephant Code
...
- **Verifique as issues existentes**: Pesquise nas [Issues do GitHub](https://github.com/Elephant-Code-Org/Elephant-Code/issues).
...
- Confira a [página de GitHub Issues](https://github.com/Elephant-Code-Org/Elephant-Code/issues) para ver as issues.
- Para documentação, visite [Documentação do Elephant Code](https://github.com/Elephant-Code-Org/Elephant-Code-Docs).

### Relatando bugs

- Verifique primeiro os relatórios existentes.
- Crie um novo bug usando o [modelo "Relatório de bug"](https://github.com/Elephant-Code-Org/Elephant-Code/issues/new/choose) com:
    - Passos de reprodução claros e numerados
    - Resultado esperado vs. real
    - Versão do Elephant Code (obrigatório); provedor/modelo de IA, se relevante
- **Problemas de segurança**: Relate em particular por meio de [avisos de segurança](https://github.com/Elephant-Code-Org/Elephant-Code/security/advisories/new).
...
Ao contribuir, você concorda que suas contribuições serão licenciadas sob a Licença Apache 2.0, consistente com o licenciamento do Elephant Code.
