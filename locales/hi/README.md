...
## Elephant Code आपके लिए क्या कर सकता है?
...
- **[दस्तावेज़ीकरण](https://docs.zoocode.dev):** Elephant Code को स्थापित करने, कॉन्फ़िगर करने और उसमें महारत हासिल करने के लिए आधिकारिक गाइड।
...
- **[गिटहब मुद्दे](https://github.com/Elephant-Code-Org/Elephant-Code/issues):** बग की रिपोर्ट करें और विकास को ट्रैक करें।
- **[सुविधा अनुरोध](https://github.com/Elephant-Code-Org/Elephant-Code/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** क्या आपके पास कोई विचार है? इसे डेवलपर्स के साथ साझा करें।
...
वीएसकोड में `F5` दबाएं (या **रन** → **डीबगिंग प्रारंभ करें** पर जाएं)। यह Elephant Code एक्सटेंशन के साथ एक नई वीएसकोड विंडो खोलेगा।
...
**Elephant Code का आनंद लें!** चाहे आप इसे short leash पर रखें या इसे autonomously घूमने दें, हम यह देखने के लिए उत्साहित हैं कि आप क्या बनाते हैं। अगर आपके पास questions या feature ideas हैं, तो एक [issue](https://github.com/Elephant-Code-Org/Elephant-Code/issues) खोलें या एक [discussion](https://github.com/Elephant-Code-Org/Elephant-Code/discussions) शुरू करें। Happy coding!
