...
>
> Daarom willen we aankondigen dat **Elephant Code** de ontwikkeling van dit belangrijke project zal voortzetten. Het kernteam bestaat uit ontwikkelaars die eerder aan Roo hebben bijgedragen en veel om deze plugin geven. We blijven modellen updaten, bugs oplossen en functies uitbrengen. Maar bovenal willen we luisteren naar jullie, de community die deze plugin zo bijzonder heeft gemaakt. Voel je dus vrij om lid te worden van onze [Discord](https://discord.gg/VxfP4Vx3gX), onze [Reddit](https://www.reddit.com/r/ZooCode), of [een PR of issue te openen](https://github.com/Elephant-Code-Org/Elephant-Code); maar vooral vragen we je om betrokken, verbonden en actief te blijven als community.
>
> _-Elephant Code Team_

## Migratie van Roo Code naar Elephant Code

Je vindt een korte handleiding voor de overstap van Roo Code naar Elephant Code in de [Roo→Zoo-migratiegids](https://docs.zoocode.dev/roo-to-zoo-migration). We willen gebruikers zo goed mogelijk helpen tijdens de overgang, en precies daarvoor zijn onze [Reddit](https://www.reddit.com/r/ZooCode) en [Discord](https://discord.gg/VxfP4Vx3gX) er. Als je ergens tegenaan loopt of vragen hebt, kom langs en vraag het.

## Nieuw in v3.54.1

**Eerste Elephant Code-release** — maakt Elephant Code een onafhankelijke extensie in de VS Code Marketplace onder `ZooCodeOrganization.zoo-code`, met pre-release builds die automatisch worden gepubliceerd na elke merge naar `main`.
...
## Wat kan Elephant Code voor JOU doen?
...
Elephant Code past zich aan jouw werkwijze aan, niet andersom:
...
- **[Documentatie](https://docs.zoocode.dev):** De officiële gids voor het installeren, configureren en beheersen van Elephant Code.
...
- **[GitHub Issues](https://github.com/Elephant-Code-Org/Elephant-Code/issues):** Meld bugs en volg de ontwikkeling.
- **[Feature Requests](https://github.com/Elephant-Code-Org/Elephant-Code/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Heb je een idee? Deel het met de ontwikkelaars.
...
Er zijn verschillende manieren om de Elephant Code-extensie uit te voeren:

### Ontwikkelmodus (F5)

Gebruik voor actieve ontwikkeling de ingebouwde foutopsporing van VSCode:

Druk op `F5` (of ga naar **Uitvoeren** → **Foutopsporing starten**) in VSCode. Dit opent een nieuw VSCode-venster waarin de Elephant Code-extensie wordt uitgevoerd.
...
**Veel plezier met Elephant Code!** Of je het nu kort aangelijnd houdt of autonoom laat rondzwerven, we kunnen niet wachten om te zien wat je bouwt. Als je vragen of feature-ideeën hebt, open dan een [issue](https://github.com/Elephant-Code-Org/Elephant-Code/issues) of start een [discussion](https://github.com/Elephant-Code-Org/Elephant-Code/discussions). Veel codeerplezier!
