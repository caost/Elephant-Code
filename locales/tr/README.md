...
## Elephant Code SİZİN İçin Ne Yapabilir?
...
Elephant Code, sizin çalışma şeklinize uyum sağlar, tam tersi değil:
...
- **[Dokümantasyon](https://docs.zoocode.dev):** Elephant Code'u yükleme, yapılandırma ve ustalaşma konusundaki resmi kılavuz.
...
- **[GitHub Sorunları](https://github.com/Elephant-Code-Org/Elephant-Code/issues):** Hataları bildirin ve gelişimi takip edin.
- **[Özellik İstekleri](https://github.com/Elephant-Code-Org/Elephant-Code/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Bir fikriniz mi var? Geliştiricilerle paylaşın.
...
Elephant Code uzantısını çalıştırmanın birkaç yolu vardır:

### Geliştirme Modu (F5)

Aktif geliştirme için VSCode'un yerleşik hata ayıklama özelliğini kullanın:

VSCode'da `F5` tuşuna basın (veya **Çalıştır** → **Hata Ayıklamayı Başlat**'a gidin). Bu, Elephant Code uzantısının çalıştığı yeni bir VSCode penceresi açacaktır.
...
**Elephant Code'un keyfini çıkar!** Onu ister kısa tasma ile yakınında tut, ister kendi başına dolaşmasına izin ver, neler inşa edeceğini görmek için sabırsızlanıyoruz. Soruların veya özellik fikirlerin varsa bir [issue](https://github.com/Elephant-Code-Org/Elephant-Code/issues) aç ya da bir [discussion](https://github.com/Elephant-Code-Org/Elephant-Code/discussions) başlat. Mutlu kodlamalar!
