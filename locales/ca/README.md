...
## Què pot fer Elephant Code per TU?
...
Elephant Code s'adapta a la teva manera de treballar, no a l'inrevés:
...
- **[Documentació](https://docs.zoocode.dev):** La guia oficial per instal·lar, configurar i dominar Elephant Code.
...
- **[Incidències de GitHub](https://github.com/Elephant-Code-Org/Elephant-Code/issues):** Informa d'errors i segueix el desenvolupament.
- **[Sol·licituds de funcionalitats](https://github.com/Elephant-Code-Org/Elephant-Code/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Tens una idea? Comparteix-la amb els desenvolupadors.
...
Hi ha diverses maneres d'executar l'extensió Elephant Code:

### Mode de desenvolupament (F5)

Per al desenvolupament actiu, utilitza la depuració integrada de VSCode:

Prem `F5` (o ves a **Executa** → **Inicia la depuració**) a VSCode. Això obrirà una nova finestra de VSCode amb l'extensió Elephant Code en funcionament.
...
**Gaudeix de Elephant Code!** Tant si el portes curt com si el deixes voltar de manera autònoma, tenim moltes ganes de veure què construiràs. Si tens preguntes o idees de funcionalitats, obre una [issue](https://github.com/Elephant-Code-Org/Elephant-Code/issues) o inicia una [discussion](https://github.com/Elephant-Code-Org/Elephant-Code/discussions). Feliç codi!
