 ...
 *
 * This class manages the state for the marketplace view in the Elephant Code extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the Elephant Code extensions interface
